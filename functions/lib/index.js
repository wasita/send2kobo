...
exports.kobo = exports.download = void 0;
...
exports.download = functions.runWith({ timeoutSeconds: 300, memory: "512MB" }).https.onRequest(async (req, res) => {
...
exports.kobo = functions.https.onRequest(async (req, res) => {
    var _a;
    // Get code and strip any hyphens, spaces, or other non-alphanumeric chars
    const rawCode = (req.query.code || ((_a = req.body) === null || _a === void 0 ? void 0 : _a.code) || "");
      ...
      `);
        ...
        if (filesQuery.empty) {
            ...
            filesQuery.docs.forEach((doc) => {
                var _a;
                const file = doc.data();
                const ext = ((_a = file.name.split(".").pop()) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || "FILE";
